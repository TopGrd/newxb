...
-->
    ...
    <div id="middle">
        ...
        <div id="m_middle">
            ...
            <a href="<?php echo $_obj['item']['file_name']; ?>">PDF下载</a>
            ...
            <div id="itemTabsBox">
                ...
                <div id="tab0" style="display:block;"><p><?php echo $_obj['item']['description']; ?></p></div>
      ...
      <span><?php echo $_obj['item']['name']; ?>.电子科技大学学报,<?php echo $_obj['this_category']['name']; ?>:<?php echo $_obj['item']['classnum']; ?>
      </span>
      <p>链接本文:</p>
