                ...
                <div id="yearsBox">
         			...
         			<?php  
         				...
         				foreach (($_obj['jarray']) as $key => $value) {
                            if($key % 5 != 0)
                            {
                                echo "<li style='left:".intval(350+80*($key%5))."px;'><a href='?p=category&category_id=-1&yid=".$i."''>".$key."</a></li>";
                            }
                            else
                            {
                                echo "<li style='left:350px;'><a href='?p=category&category_id=-1&yid=".$i."''>".$key."</a></li></ul><br/><ul class='middle-years'>";
                            }
