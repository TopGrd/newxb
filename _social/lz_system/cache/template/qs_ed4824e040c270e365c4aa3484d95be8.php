...
?></a></li>
   ...
   <script type="text/jscript">
       $("#newsrock").kxbdMarquee();
         ...
         <p style="margin-left:150px;"><a href="index.php?p=category&category_id=2" style="color:red;">更多...</a></p>
    </ul>    
</div>
     <div class="panel1 jian">
        <ul class="ull">
            <li class="mainitem"><img class="icon1" src="images/moleskine_pure.png"><span class="title1">期刊信息</span></li>
            <li><span class="mainfo2">1959年创刊，双月刊</span></li>
            <li><span class="mainfo2">主管：</span></li>
            <li><span class="mainfo2">主办：电子科技大学</span></li>
            <li><span class="mainfo2">主编：周小佳</span></li>
