...
?> 
    ...
    <ul class="ull">
    <li class="mainitem mainitem_T"><img class="icon1" src="images/ann.png"><span class="title1">信息公告</span></li>
        <div id="newsrock">
            <ul class="newspan">
                <marquee align="bottom" direction="up" onmouseover="this.stop()" onmouseout="this.start()" behavior="scroll" scrollamount="1">
...
?></a></li>
            	<?php } $_obj=$_stack[--$_stack_cnt];} ?> </marquee> 
            </ul>
       </div> 
         <p class="morein"><a href="index.php?p=category&category_id=2" style="color:red;">更多...</a></p>
    </ul>    
</div>
     <div class="panel1 jian just">
        <ul class="ull">
            ...
            <li><span class="mainfo2">出版物号：CN 51-1207/T</span></li>
            <li><span class="mainfo2 mr8">ISSN 1001-0548</span></li>
            ...
            <li><span class="mainfo2">电话号码：(028)83202308，</span></li>
            <li><span class="mainfo2 mr8">83207559</span></li>
