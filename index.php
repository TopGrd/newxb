...
$conn=mysqli_connect("222.197.171.171","root","159357");
...
<body>
	<div id="wrap">
        <div id="container">
        	...
        	<div class="boxBig">
            	<a class="linkImg" target="_blank" href="http://localhost/new_xb/nature/index.php"><img src="images/img_101.jpg" /></a>
                <p class="spaceP"><a class="linkN" target="_blank" href="http://localhost/new_xb/nature/index.php"><span class="strong">电子科技大学学报-自科版</span></a></p>
        	...
        	<div class="boxBig">
            	<a class="linkImg" target="_blank" href="http://localhost/new_xb/social/index.php"><img src="images/img_102.jpg" /></a>
                <p class="spaceP"><a class="linkN" target="_blank" href="http://localhost/new_xb/social/index.php"><span class="strong">电子科技大学学报-社科版</span></a></p>
            </div>
        	<div class="boxBig">
            	<a class="linkImg" target="_blank" href="http://www.journal.uestc.edu.cn/"><img src="images/img_103.jpg" /></a>
                <p class="spaceP"><a class="linkN" target="_blank" href="http://www.journal.uestc.edu.cn/"><span class="strong">Journal of Electronic Science and Technology</span></a></p>
            </div>
        	<div class="boxBig">
